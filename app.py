    ...
    with st.form("main_form"):
        ...
        if st.form_submit_button("Сформировать универсальный отчет"):
            with st.spinner("Глубокий поиск обязательств и требований..."):
                ...
                # ИНСТРУКЦИЯ: Писать отчет строго по пунктам ТЗ
                report_prompt = f"""Напиши отчет о выполнении ТЗ.
                Для каждого требования/услуги из ТЗ напиши абзац в прошедшем времени ('Услуга оказана', 'Документ разработан').
                Используй факты: {facts}
                ТЕКСТ КОНТРАКТА: {full_text}"""
