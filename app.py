            ...
            try:
                res = client_ai.chat.completions.create(
                    ...
                    messages=[{
                        ...
                        - contract_date_raw: дата контракта как написана (пример: «  »         2025 г.)
                        - ikz: ТОЛЬКО 36-значное число после слов "ИКЗ", "Идентификационный код закупки" или "ИКЗ 25..." - найди именно его, игнорируй другие номера
